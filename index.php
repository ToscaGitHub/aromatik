...
<!-- Corps du Site avec les différentes DIV représentant les catégories de la NAVBAR. -->
    ...
    <main>
        <div class=".uk-animation-slide-right socialmedia">
            ...
            <a href="https://www.facebook.com/profile.php?id=100064815141991" class="social" uk-icon="icon: facebook"></a>
            <a href="https://www.instagram.com/aromatik_mds/?hl=fr" class="social" uk-icon="icon: instagram"></a>
